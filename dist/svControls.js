function svControls(videoElement, options = {}) {
    ...
    volumeDiv.innerHTML = self.options.volume.icon;
    ...
    if (self.options.play.show !== false) {
        btnArea1.append(playBtn);
    }
    if (self.options.pause.show !== false) {
        btnArea1.append(pauseBtn);
    }
    if (self.options.stop.show !== false) {
